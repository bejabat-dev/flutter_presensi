...
class _$ScheduleEntityImpl implements ScheduleEntity {
  ...
  @override
  String toString() {
    return 'Schedule.entity(isWfa: $isWfa, isBanned: $isBanned, office: $office, shift: $shift)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return entity(isWfa, isBanned, office, shift);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return entity?.call(isWfa, isBanned, office, shift);
  }
